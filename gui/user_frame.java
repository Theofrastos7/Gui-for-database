...
public class user_frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        reg_date_text = new javax.swing.JTextField();
        ...
        reg_date_label.setText("Reg_date");
        ...
        reg_date_text.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reg_date_textActionPerformed(evt);
            }
        });
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    .addComponent(reg_date_text, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(lastname_text, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(reg_date_text, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_buttonActionPerformed
       ...
       try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("INSERT INTO user(username, password, name, "
                    + "lastname, reg_date, email)VALUES (?, ?, ?, ?, CURRENT_TIMESTAMP, ?)");
            
            pst.setString(1, username_text.getText());
            pst.setString(2, password_text.getText());
            pst.setString(3, name_text.getText());
            pst.setString(4, lastname_text.getText());
            pst.setString(5, email_text.getText());
       ...
       {
           java.util.logging.Logger.getLogger(user_frame.class.getName()).log(java.util.logging.Level.SEVERE,
                   null, ex);  
       }
     ...
     try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("DELETE FROM user WHERE username = ?");
    ...
    private void update_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_buttonActionPerformed
        try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("UPDATE user SET username = ?, password = ?, name = ?, "
                    + "lastname = ?, reg_date = CURRENT_TIMESTAMP, email = ? WHERE username = ?");
            ...
            pst.setString(6, username_text.getText()); // Use the username entered by the user
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        password_text.setText(RecordTable.getValueAt(SelectedRows, 1).toString());   
        name_text.setText(RecordTable.getValueAt(SelectedRows, 2).toString());   
        lastname_text.setText(RecordTable.getValueAt(SelectedRows, 3).toString());   
        reg_date_text.setText(RecordTable.getValueAt(SelectedRows, 4).toString());   
        email_text.setText(RecordTable.getValueAt(SelectedRows, 5).toString());   
        
    }//GEN-LAST:event_jTable1MouseClicked

    private void reg_date_textActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reg_date_textActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_reg_date_textActionPerformed
    ...
    private javax.swing.JTextField reg_date_text;
