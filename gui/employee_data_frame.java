 ...
 * @author Theo
 */
public class employee_data_frame extends javax.swing.JFrame {
    ...
    try {
        ...
        pst = sqlConn.prepareStatement("SELECT * FROM employee WHERE username = ?");
    ...
    private void initComponents() {
        ...
        Username_label.setText("Enter the employee's username: ");
    ...
    private void check_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_check_buttonActionPerformed
        ...
        try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("Select job_id FROM applies WHERE em_username = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employee_data_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employee_data_frame().setVisible(true);
            }
        });
    }
