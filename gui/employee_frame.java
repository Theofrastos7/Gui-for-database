...
public class employee_frame extends javax.swing.JFrame {
        ...
        try 
        {
            ...
            while(rs.next())
            {
                ...
                for (i = 1; i<= q; i++)
                {
                    ...
                    columnData.add(rs.getString("sistatikes"));
                    columnData.add(rs.getString("certificates"));
    ...
    private void initComponents() {
        ...
        bio_text = new javax.swing.JTextField();
        sistatikes_text = new javax.swing.JTextField();
        certificates_text = new javax.swing.JTextField();
        ...
        Password_label.setText("Bio");

        name_label.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        name_label.setText("Sistatikes");

        lastname_label.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lastname_label.setText("Certificates");

        sistatikes_text.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sistatikes_textActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(43, 43, 43)
                                        .addComponent(sistatikes_text, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(41, 41, 41)
                                        .addComponent(certificates_text, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(33, 33, 33)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(bio_text, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(35, 35, 35)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(update_button)
                    .addComponent(bio_text, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(sistatikes_text, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(delete_button))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(certificates_text, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_buttonActionPerformed
       ...
       try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("INSERT INTO employee(username, bio, sistatikes, "
                    + "certificates) VALUES (?, ?, ?, ?)");
            
            pst.setString(1, username_text.getText());
            pst.setString(2, bio_text.getText());
            pst.setString(3, sistatikes_text.getText());
            pst.setString(4, certificates_text.getText());
       ...
       {
           java.util.logging.Logger.getLogger(employee_frame.class.getName()).log(java.util.logging.Level.SEVERE,
                   null, ex);  
       }
     ...
     try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("DELETE FROM employee WHERE username = ?");
    ...
    private void sistatikes_textActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sistatikes_textActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sistatikes_textActionPerformed
    ...
    private void reset_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reset_buttonActionPerformed
       ...
       sistatikes_text.setText("");
       certificates_text.setText("");
       bio_text.setText("");
    ...
    private void update_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_buttonActionPerformed
        try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("UPDATE employee SET username = ?, bio = ?, sistatikes = ?, "
                    + "certificates = ? WHERE username = ?");
            ...
            pst.setString(5, username_text.getText()); // Use the username entered by the user
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        bio_text.setText(RecordTable.getValueAt(SelectedRows, 1).toString());   
        sistatikes_text.setText(RecordTable.getValueAt(SelectedRows, 2).toString());   
        certificates_text.setText(RecordTable.getValueAt(SelectedRows, 3).toString());    
    ...
    private javax.swing.JTextField bio_text;
    private javax.swing.JTextField certificates_text;
    ...
    private javax.swing.JTextField sistatikes_text;
