 ...
 * @author Theo
 */
public class DBA_frame extends javax.swing.JFrame {
    ...
    public void upDateDB()
    {
        try 
        {
            ...
            pst = sqlConn.prepareStatement("Select * FROM DBA");
            ...
            while(rs.next())
            {
                ...
                for (i = 1; i<= q; i++)
                {
                    ...
                    columnData.add(rs.getDate("end_date"));
    ...
    private void initComponents() {
        ...
        ebd_date = new javax.swing.JTextField();
        ...
        name_label.setText("ebd_date");

        ebd_date.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ebd_dateActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(60, 60, 60)
                                .addComponent(ebd_date, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(33, 33, 33)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(ebd_date, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(delete_button))
    ...
    private void insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_buttonActionPerformed
       ...
       try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("INSERT INTO DBA(username, start_date, "
                    + "end_date) VALUES (?, ?, ?)");
            
            pst.setString(1, username_text.getText());
            pst.setString(2, start_date_text.getText());
            pst.setString(3, ebd_date.getText());
       ...
       {
           java.util.logging.Logger.getLogger(DBA_frame.class.getName()).log(java.util.logging.Level.SEVERE,
                   null, ex);  
       }
     ...
     try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("DELETE FROM DBA WHERE username = ?");
    ...
    private void ebd_dateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ebd_dateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ebd_dateActionPerformed
    ...
    private void update_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_buttonActionPerformed
        try 
        {
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(DB_URL,username,password);
            pst = sqlConn.prepareStatement("UPDATE dba SET username = ?, start_date = ?, end_date = ? "
                    + " WHERE username = ?");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        ebd_date.setText(RecordTable.getValueAt(SelectedRows, 2).toString());      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBA_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField ebd_date;
